<form action="{{ route('backend.master.aplikasicreate') }}" method="post">
    @csrf

    <div class="form-group">
        <label>Nama Aplikasi*</label>
        <input type="text" id="nama_aplikasi" name="nama_aplikasi" placeholder="minimal 3 karakter huruf" class="form-control" required>
    </div>
