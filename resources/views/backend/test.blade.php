                    ...
                    <div class="panel-body">
                        <div class="row">
                                ...
                                <div class="widget style1 lazur-bg">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-8 text-right">
                                            <span> Rata rata booking bulan ini </span>
                                            <h2 class="font-bold">{{ ceil($current_month_avg) }} perhari</h2>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="widget style1 lazur-bg">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-8 text-right">
                                            <span> Rata rata user terdaftar bulan ini </span>
                                            <h2 class="font-bold">{{ ceil($usermonthavg) }} perhari</h2>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-4">
                                ...
                                <small>
                                    Total booking 6 bulan terakhir
                                </small>
                                <div id="sparkline1" class="m-b-sm"></div>
                                <div class="row">
                                    <div class="col-xs-3">
                                        <small class="stats-label">Pemesanan</small>
                                        <h4>{{ $lastsixmonth }}</h4>
                                    </div>

                                    <div class="col-xs-3">
                                        <small class="stats-label">Batal</small>
                                        <h4>{{ $lastsixmonthcancel }}</h4>
                                    </div>
                                    <div class="col-xs-3">
                                        <small class="stats-label">Menunggu konfirmasi klinik</small>
                                        <h4>{{ $lastsixmonthconfirm }}</h4>
                                    </div>
                                    <div class="col-xs-3">
                                        <small class="stats-label">Telah dikonfirmasi klinik</small>
                                        <h4>{{ $lastsixmonthsuccessconfirm }}</h4>
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-4">
                                <h1 class="m-b-xs">
                                    {{ ($userweek) ? $userweek->jumlahregistrasi : 0  }}
                                </h1>
                                <small>
                                    Registrasi baru minggu ini
                                </small>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-4">
                                        <small class="stats-label">Minggu ini</small>
                                        <h4>{{ ($userweek) ? $userweek->jumlahregistrasi : 0  }}</h4>
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="row m-t-xs">
                                    <div class="col-xs-6">
                                        <h5 class="m-b-xs">Jumlah booking
                                            bulan {{ \Carbon\Carbon::now()->subMonth()->formatLocalized('%B') }}</h5>
                                        <h1 class="no-margins">{{ $last_month_total }}</h1>
                                    </div>
                                    <div class="col-xs-6">
                                        <h5 class="m-b-xs">Jumlah booking
                                            bulan {{ \Carbon\Carbon::now()->formatLocalized('%B') }}</h5>
                                        <h1 class="no-margins">{{ $current_month_total }}</h1>
                                    </div>
                                </div>
                                ...
                                <table class="table small m-t-sm">
                                    ...
                                    <tr>
                                        <td>
                                            <strong>{{ $last_month_pemesanan }}</strong> Pemesanan

                                        </td>
                                        <td>
                                            <strong>{{ $current_month_pemesanan }}</strong> Pemesanan
                                        </td>

                                    </tr>
                                    <tr>
                                        <td>
                                            <strong>{{ $last_month_batal }}</strong> Batal
                                        </td>
                                        <td>
                                            <strong>{{ $current_month_batal }}</strong> Batal
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <strong>{{ $last_month_menunggu_konfirmasi }}</strong> Menunggu konfirmasi
                                            klinik
                                        </td>
                                        <td>
                                            <strong>{{ $current_month_menunggu_konfirmasi }}</strong> Menunggu
                                            konfirmasi klinik
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <strong>{{ $last_month_telah_dikonfirmasi }}</strong> Telah dikonfirmasi
                                            klinik
                                        </td>
                                        <td>
                                            <strong>{{ $current_month_telah_dikonfirmasi }}</strong> Telah dikonfirmasi
                                            klinik
                                        </td>
                                    </tr>
                                    </tbody>
